...
//	bs.BridgeLock.Lock()
//	defer bs.BridgeLock.Unlock()
//	if _, ok := bs.ActiveBridge.AllocateMap[address]; ok {
//		return 1
//	}
//	if _, ok := bs.IdleBridge.AllocateMap[address]; ok {
//		return 0
//	}
//	return -1
//}
...
//	shardList := []uint64{}
//	if isBridge == 1 {
//		_, shardList = utils.GetMapShard(bs.ActiveBridge.AllocateMap[addr])
//	} else if isBridge == 0 {
//		_, shardList = utils.GetMapShard(bs.IdleBridge.AllocateMap[addr])
//	}
...
//		shardMap := bs.ActiveBridge.AllocateMap[addr]
//		count = 0
