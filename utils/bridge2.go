...
//}
//
//func (bs *Bridge) GetBridgeShardList(addr Address) (int, []uint64) {
//	isBridge := bs.IsBridge(addr)
//	shardList := []uint64{}
//	if isBridge == 1 {
//		_, shardList = GetMapShard(bs.ActiveBridge.AllocateMap[addr])
//	} else if isBridge == 0 {
//		_, shardList = GetMapShard(bs.IdleBridge.AllocateMap[addr])
//	}
...
//		}
//		allShardSet[uint64(Addr2Shard(addr))] = true
